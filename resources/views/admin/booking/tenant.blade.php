...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
	...
	<li class="breadcrumb-item text-active">
		<a href="{{ route('admin.tenant.list')}}" class="text-active">Tenant List</a>
	</li>
</ul>
@endsection
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title mb-0">
                <h5 class="card-label">Table showing all tenants booking requests
        ...
        <div class="card-body">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="datatable">
                ...
                <tbody>
                    ...
                    @if(isset($owner) )
                        @foreach ($owner->ownerBooking as $book)
                        @if($book->status==1)
                        <tr>
                            ...
                            {{-- {{-- <td>{{$book->address}}</td> --}}
                            <td>{{$book->recent_address}}</td>
                            <td>{{$book->income}} / {{$book->expenses}}</td> 
