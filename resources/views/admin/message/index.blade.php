...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
	...
	<li class="breadcrumb-item text-active">
		<a href="{{ route('admin.message.index')}}" class="text-active">Message</a>
	</li>
</ul>
@endsection
                        ...
                        <tbody>
                            ...
                            @if(isset($msg->receiver))
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <form  action="{{route('admin.message.destroy', $report->id) }}" method="post">
                                            @method('delete')
                                            @csrf
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="receiver_id" required>
                        @foreach($user as $us)
                            <option value="{{$us->id}}">{{$us->name}} ({{$us->role}})</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
